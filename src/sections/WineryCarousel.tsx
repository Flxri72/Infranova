...
import { caseStudyConfig, navigationConfig } from '../config';

export function WineryCarousel() {
  // Null check: if config is empty, render nothing
  if (!caseStudyConfig.mainTitle || caseStudyConfig.slides.length === 0) return null;

  const slides = caseStudyConfig.slides;
    ...
    >
      ...
      <div className="container-custom relative">
        ...
        <div className="fade-up text-center mb-12">
          <span className="font-script text-3xl text-blue-400 block mb-2">{caseStudyConfig.scriptText}</span>
          <span className="text-blue-500 text-xs uppercase tracking-[0.2em] mb-4 block">
            {caseStudyConfig.subtitle}
          </span>
          <h2 className="font-serif text-h1 text-white">
            {caseStudyConfig.mainTitle}
          </h2>
        </div>
                ...
                >
                  ...
                  {navigationConfig.ctaButtonText && (
                    <button
                      ...
                      className="btn-dark rounded-sm bg-blue-500/20 border-blue-500/30 hover:bg-blue-500 hover:border-blue-500"
